 ...
 *
 * Tests the simplified Session class with FIFO pipes and binary prefixes.
 * No isolation/unshare complexity - just persistent bash with proper output separation.
 */
