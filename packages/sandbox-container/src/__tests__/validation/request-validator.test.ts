...
import type { ValidationResult } from '#container/core/types.ts';
import type { SecurityService } from '#container/security/security-service.ts';
import type { RequestValidator } from '#container/validation/request-validator.ts';
import type { MkdirRequest, ReadFileRequest } from '#container/validation/schemas.ts';
...
describe('RequestValidator', () => {
  ...
  beforeEach(async () => {
    ...
    const { RequestValidator: RequestValidatorClass } = await import('#container/validation/request-validator.ts');
