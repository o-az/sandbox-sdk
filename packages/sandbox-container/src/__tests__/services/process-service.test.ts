...
import type { Logger, ProcessRecord, ProcessOptions } from '#container/core/types.ts';
import type { ProcessStore, ProcessFilters, ProcessService } from '#container/services/process-service.ts';
import type { BunProcessAdapter, SpawnResult, ExecutionResult, StreamHandlers, SpawnOptions } from '#container/adapters/bun-process-adapter.ts';
...
describe('ProcessService', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('#container/services/process-service.ts');
