...
import type { FileStats, Logger } from '#container/core/types.ts';
import type { FileService, SecurityService } from '#container/services/file-service.ts';
import type { BunFileAdapter, FileContent } from '#container/adapters/bun-file-adapter.ts';
import type { ExecutionResult } from '#container/adapters/bun-process-adapter.ts';
...
describe('FileService', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('#container/services/file-service.ts');
