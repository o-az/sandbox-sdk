...
import type { Logger, CloneOptions } from '#container/core/types.ts';
import type { GitService, SecurityService } from '#container/services/git-service.ts';
import type { BunProcessAdapter, ExecutionResult } from '#container/adapters/bun-process-adapter.ts';
...
describe('GitService', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('#container/services/git-service.ts');
