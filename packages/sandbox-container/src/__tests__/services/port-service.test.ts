...
import type { Logger, PortInfo, PortNotFoundResponse, ProxyErrorResponse } from '#container/core/types.ts';
import type { PortService, PortStore, SecurityService } from '#container/services/port-service.ts';
...
describe('PortService', () => {
  ...
  beforeEach(async () => {
    ...
    const { PortService: PortServiceClass } = await import('#container/services/port-service.ts');
