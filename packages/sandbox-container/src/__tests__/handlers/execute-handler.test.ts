...
import type { ExecuteRequest, ExecuteResponse, Logger, RequestContext, ServiceResult, ValidatedRequestContext } from '#container/core/types.ts';
import type { ExecuteHandler } from '#container/handlers/execute-handler.ts';
...
describe('ExecuteHandler', () => {
  ...
  beforeEach(async () => {
    ...
    const { ExecuteHandler: ExecuteHandlerClass } = await import('#container/handlers/execute-handler.ts');
