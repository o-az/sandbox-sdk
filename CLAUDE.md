...
**Critical:** Docker image version MUST match npm package version (`@cloudflare/sandbox@0.4.7` → `cloudflare/sandbox:0.4.10`). This is enforced via `ARG SANDBOX_VERSION` in Dockerfile.
